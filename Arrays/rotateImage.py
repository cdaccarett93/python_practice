...
test2 = [[1]]
test3 = [[10, 9, 6, 3, 7], [6, 10, 2, 9, 7], [7, 6, 3, 8, 2], [8, 9, 7, 9, 9], [6, 8, 6, 8, 2]]
test4 = [[40, 12, 15, 37, 33, 11, 45, 13, 25, 3], [37, 35, 15, 43, 23, 12, 22, 29, 46, 43],
...
test5 = [[33, 35, 8, 24, 19, 1, 3, 1, 4, 5], [25, 27, 40, 25, 17, 35, 20, 3, 19, 3],
...
class MyTest(unittest.TestCase):
    def test_rotateImage(self):
        self.assertEqual(rotateImage(test1), [[7, 4, 1], [8, 5, 2], [9, 6, 3]])
        self.assertEqual(rotateImage(test2), [[1]])
        self.assertEqual(rotateImage(test3),
                         [[6, 8, 7, 6, 10], [8, 9, 6, 10, 9], [6, 7, 3, 2, 6], [8, 9, 8, 9, 3], [2, 9, 2, 7, 7]])
        self.assertEqual(rotateImage(test4),
                         [[8, 38, 12, 31, 14, 45, 48, 44, 37, 40], [46, 23, 13, 9, 9, 17, 4, 19, 35, 12],
        ...
        self.assertEqual(rotateImage(test5),
                         [[18, 33, 45, 8, 37, 40, 30, 9, 25, 33], [19, 15, 48, 26, 42, 46, 47, 1, 27, 35],
